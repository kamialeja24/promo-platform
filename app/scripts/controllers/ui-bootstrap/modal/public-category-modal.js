...
angular.module('promoPlatformApp')
  .controller('PublicCategoryModalCtrl',['$scope','$modal','$log','CategoryService','SweetAlert', function ($scope, $modal, $log, CategoryService, SweetAlert) {
    ...
    $scope.categoryModal = function (size) {
      ...
      var modalInstance = $modal.open({
        ...
        controller: function ($scope, $modalInstance) {
          var categoriesPromise = CategoryService.getPublicMiddleCategories();
