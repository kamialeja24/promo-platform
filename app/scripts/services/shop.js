...
.factory('ShopService',['$http','ApiEndpoint',function($http,ApiEndpoint){
    ...
    var deleteProductOfShop = function (manager,shop_id,product_id){
      return $http.delete(ApiEndpoint.url + '/platform/managers/'+manager.id+'/shops/'+shop_id+'/products/'+product_id);
    };
    ...
    return {createShop: createShop,
            ...
            deleteProductOfShop:deleteProductOfShop};
}]);
